...
const CartCards = ({item , totalAmount , setTotalAmount}) => {
    ...
    const handleQuantityChange = (newQuantity) => {
      ...
      // Calculate the new total amount when the quantity changes
      const newTotalAmount =
        parseFloat(totalAmount) + (newQuantity - item.quantity) * item.price;
      ...
      <div className="items flex items-start gap-6">
        ...
        <div className="right w-full">
          ...
          <div className="btm mt-2 flex items-center justify-between">
            <h3 className="font-satoshi-bold text-[20px] md:text-[24px]">
              ${item.price * quantity}
            </h3>
